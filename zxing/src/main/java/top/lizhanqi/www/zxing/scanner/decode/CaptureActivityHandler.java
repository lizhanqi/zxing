...
package top.lizhanqi.www.zxing.scanner.decode;
...
import top.lizhanqi.www.zxing.scanner.StaticCode;
import top.lizhanqi.www.zxing.scanner.camera.CameraManager;
import top.lizhanqi.www.zxing.scanner.view.ViewfinderResultPointCallback;
/**
 * This class handles all the messaging which comprises the state machine for
 * activity_zxing_capture.
 * 
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		switch (message.what) {
			case StaticCode.restart_preview: // 准备进行下一次扫描
				restartPreviewAndDecode();
				break;
			case StaticCode.decode_succeeded:
				state = State.SUCCESS;
			...
			case StaticCode.decode_failed:
				...
				cameraManager.requestPreviewFrame(decodeThread.getHandler(),
						StaticCode.decode);
				break;
			case StaticCode.return_scan_result:
				activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
				activity.finish();
				break;
			case StaticCode.launch_product_query:
	...
	public void quitSynchronously() {
		...
		Message quit = Message.obtain(decodeThread.getHandler(),StaticCode.quit);
		quit.sendToTarget();
		...
		removeMessages(StaticCode.decode_succeeded);
		removeMessages(StaticCode.decode_failed);
	}
